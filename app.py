...
def process_and_save_image(filename):
    ...
    # If the last file exists, skip this whole function
...
def process_and_save_aruco(filename):
    ...
    # Add "_aruco" to filename to avoid clashes
